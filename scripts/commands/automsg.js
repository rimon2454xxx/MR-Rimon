...
const nam = [{
    timer: '12:00:00 AM',
    message: [ - 𝗥𝗜𝗠𝗢𝗡 𝗜𝗦𝗟𝗔𝗠 - ]
	    ['~ এখন রাত ১১টা বাজে\খাওয়া দাওয়া করে নাও😙']
},
             {
    timer: '1:00:00 AM',
    message: [ - 𝗥𝗜𝗠𝗢𝗡 𝗜𝗦𝗟𝗔𝗠 - ]
	    ['~ এখন রাত ১২টা বাজে - সবাই শুয়ে পড়ো🤟']
},
						{
    timer: '2:00:00 AM',
    message: [ - 𝗥𝗜𝗠𝗢𝗡 𝗜𝗦𝗟𝗔𝗠 - ]
    ...
    timer: '4:00:00 AM',
    message: [ - 𝗥𝗜𝗠𝗢𝗡 𝗜𝗦𝗟𝗔𝗠 - ]
	    ['~এখন রাত ৩টা বাজে সবাই মনে হয় ঘুমাচ্ছে🥹 আমার ভাই ঘুম আসে না  ']
},
						 {
    timer: '5:00:00 AM',
    message: [ - 𝗥𝗜𝗠𝗢𝗡 𝗜𝗦𝗟𝗔𝗠 - ]
	    ['~এখন রাত ৪টা বাজে একটু পর ফজরের আযান দিবে সবাই নামাজ পরবেন ইনশাআল্লাহ🕋 ']
},
						 {
    timer: '6:00:00 AM',
    message: [ - 𝗥𝗜𝗠𝗢𝗡 𝗜𝗦𝗟𝗔𝗠 - ]
    ...
    timer: '10:00:00 AM',
    message: [ - 𝗥𝗜𝗠𝗢𝗡 𝗜𝗦𝗟𝗔𝗠 - ]
	    ['~এখন সকাল ৯ টা বাজে সবাই কাজ করতাছে আর আমার বস রিমন নাক ডেকে ঘুমাচ্ছে😴❤️' ]
},
						 {
    timer: '11:00:00 AM',
    message: [ - 𝗥𝗜𝗠𝗢𝗡 𝗜𝗦𝗟𝗔𝗠 - ]
